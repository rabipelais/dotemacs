...
#+BEGIN_SRC emacs-lisp
    (set-frame-font "-CTDB-Fira Code-normal-normal-normal-*-14-*-*-*-m-0-iso10646-1")
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-ref
    ...
    (setq reftex-default-bibliography '((concat seb/braindump-folder "references.bib")))
    (setq bibtex-completion-notes-path seb/braindump-folder 
	  bibtex-completion-bibliography '((concat seb/braindump-folder "references.bib"))
