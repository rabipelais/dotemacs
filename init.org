...
=C-c c= re-runs the last compile command without prompting — essential for fast GPU iteration.
=compilation-skip-threshold 2= makes error navigation jump only to errors, skipping verbose
warning spam common in CUDA/template-heavy builds.
