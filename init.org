...
=<f5>= re-runs the last compile command without prompting — essential for fast GPU iteration.
...
(global-set-key (kbd "<f5>") #'recompile)           ;; rerun last compile without prompt
...
(cheatsheet-add-group 'Compilation
                      ...
                      '(:key "<f5>"  :description "Recompile (repeat last compile command)")
...
#+BEGIN_SRC emacs-lisp
  ...
  (with-eval-after-load 'cider
    ...
    (with-eval-after-load 'clojure-mode
      (define-key clojure-mode-map (kbd "C-c P o") #'portal/open)
      (define-key clojure-mode-map (kbd "C-c P c") #'portal/clear)
      (define-key clojure-mode-map (kbd "C-c P x") #'portal/close)
      (define-key clojure-mode-map (kbd "C-c P t") #'portal/tap-last)))

(cheatsheet-add-group 'Portal
                      '(:key "C-c P o" :description "Open Portal inspector (registers tap> target)")
                      '(:key "C-c P c" :description "Clear all Portal values")
                      '(:key "C-c P x" :description "Close Portal and remove from tap>")
                      '(:key "C-c P t" :description "tap> the last REPL result (*1)"))
#+END_SRC
